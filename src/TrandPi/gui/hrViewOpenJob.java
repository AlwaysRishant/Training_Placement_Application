 ...
 * @author HP
 */
public class hrViewOpenJob extends javax.swing.JFrame {
private DefaultTableModel model;
    private List<JobPojo> allAppliedJobList;
    /**
     * Creates new form hrViewOpenJob
     */
    public hrViewOpenJob() {
        initComponents();
         this.setLocationRelativeTo(null);
         lblname.setText(CurrentUser.getName());
        model=(DefaultTableModel)tblallappliedjob.getModel();
        loadavailableopenJobs();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hrViewOpenJob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadavailableopenJobs() {
        try{
            allAppliedJobList=hrDAO.hrGetOpenAllAvailablejob();
